...
Table~\ref{tab:single} shows authentication strength for various channel types based on empirical analysis of platform security features and published breach data.
